              ...
              child: OutlinedButton.icon(
                onPressed: () async {
                  ...
                  for (int i = 0; i < 120; i++) {
                    ...
                    final result = web.window.getProperty(
                      'googleLoginResult'.toJS,
                    );
                    if (result != null && result.isA<JSString>()) {
                      idToken = (result as JSString).toDart;
                      // 清除結果
                      web.window.setProperty('googleLoginResult'.toJS, null);
                      break;
                    }
                  }
                  ...
                  if (idToken != null) {
                    ...
                    if (mounted) {
                      ScaffoldMessenger.of(
                        context,
                      ).showSnackBar(SnackBar(content: Text('Google 登入取消或超時')));
                    }
                  }
                  setState(() {});
                },
